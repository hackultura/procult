...
from procult.authentication.views import (
    ...
    ExportProposalsView,
    ExportProposalsSingleView,
    CompressProposalFilesView,
    CompressProposalAllFilesView,
    ProposalOwnListView,
...
urlpatterns += [
    ...
    url(r'^api/v1/propostas/export/csv/(?P<notice_pk>\d+)/$', ExportProposalsSingleView.as_view()),
    ...
    url(r'^api/v1/propostas/zip/(?P<notice_pk>\d+)$',
        CompressProposalAllFilesView.as_view()),
